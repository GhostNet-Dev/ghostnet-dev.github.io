export class Diffusion {
    ...
    generateImage() {
        ...
        if (this.m_model == "UNetModel") {
            ...
            const vea = "";
            const lora = "";
            this.m_ipc.SendMsg("generateImage2", prompt, nprompt, height, width, step, seed, this.m_model, samplingMethod, cfgScale, strength, batchCnt, schedule, clipSkip, vea, lora);
        }
    }
